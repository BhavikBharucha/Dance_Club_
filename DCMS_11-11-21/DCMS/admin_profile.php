...
<html>
    ...
    if (isset($_POST['btnupdate'])) {
        ...
        $q = "UPDATE tblmember SET firstname='$fname',middlename='$mname',lastname='$lname',city='$city',dob='$dob',gender='$gen',contactno='$num',email='$email',instituteid='$inst_id',password='$pass_text' WHERE id='" . $row['id'] . "'";
        echo $q;
