...
<html>
    <head>
        ...
        include './head.php';
        ?>
        <title>Add Student Member | Dance Club Management System</title>
        <style>
            .heading {
                font-size: 19px;
                font-weight: bold;
...
//                $enro=$_POST['txtenro'];
//                echo $enro;
                $sql = "insert into tblstudent(enro,firstname,middlename,lastname,city,gender,contactno,email,instituteid,status) values('" . $_POST['txtenro'] . "','" . $_POST['txtfname'] . "','" . $_POST['txtmname'] . "','" . $_POST['txtlname'] . "','" . $_POST['city'] . "','" . $_POST['gender'] . "','" . $_POST['txtnumber'] . "','" . $_POST['txtemail'] . "','" . $_POST['drwninstitute'] . "','A')";
                echo $sql;
                $result = mysqli_query($con, $sql);
                if ($result) {
                    echo 'thay to che......';
