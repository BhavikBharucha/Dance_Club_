...
<html>
    <head>
        <title>Update Chairman | Dance Club Management System</title>
        <?php
        include './head.php';
        ?>
        <style>
...
if (isset($_POST['btnadd'])) {
    ...
    if ($r) {
        echo "<script> window.alert('Updated Successfully !'); window.location.href='admin_manage_chairman.php' </script>";
    } else {
