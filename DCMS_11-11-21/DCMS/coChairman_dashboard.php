...
<html>
    <head>
        <title>Co-Chairman Dashboard | Dance Club Management System</title>
        <?php
        include './head.php';
        ?>
        <style>
                ...
                <section>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="coChairman_manage_events.php" style="text-decoration: none;">
                        ...
                        <div class="col-md-4">
                            <a href="coChairman_manage_member_coordinator.php" style="text-decoration: none; ">
                        ...
                        <div class="col-md-4">
                            <a href="coChairman_manage_judges.php" style="text-decoration: none;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="coChairman_manage_criteria.php" style="text-decoration: none;">
                        ...
                        <div class="col-md-4">
                            <a href="coChairman_manage_score.php" style="text-decoration: none;">
