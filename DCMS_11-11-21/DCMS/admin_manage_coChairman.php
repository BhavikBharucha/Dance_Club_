...
<html>
    <head>
        <title>Manage Co-Chairman | Dance Club Management System</title>
        <?php
        include './head.php';
        ?>
    </head>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Co-Chairman Details</strong>
                                            <div style="float: right;"><a href="admin_add_coChairman.php" class="btn btn-info"><i class="fa fa-plus"></i> Add</a>
                                        ...
                                        <div class="card-body">
                                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $sql = "SELECT  m.id,m.firstname, m.middlename, m.lastname, m.city, m.dob, m.gender, m.contactno, m.email,i.institutename, m.role, m.status FROM tblmember m INNER JOIN tblinstitute i ON m.instituteid=i.id WHERE m.role='Co-Chairman' and m.status='A'";
