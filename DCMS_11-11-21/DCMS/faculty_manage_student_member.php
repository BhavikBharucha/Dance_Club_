...
<html>
    <head>
        ...
        include './head.php';
        ?>
        <title>Manage Student Member | Dance Club Management System</title>
    </head>
    <body>
        <?php
        include './sidebar.php';
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div style="float: right;"><a href="faculty_add_student_member.php" class="btn btn-info"><i class="fa fa-plus"></i> Add</a>
