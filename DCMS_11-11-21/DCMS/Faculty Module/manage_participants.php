...
<html>
    <head>
        ...
        include './head.php';
        ?>
        <title>Manage Participants | Faculty Dashboard</title>
    </head>
    <body>
        <?php
        include './sidebar.php';
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($rs_result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                <?php
                                                                echo "<a href='add_participants.php?eid=" . $row['id'] . "&type=" . $row['eventtype'] . "' class='btn btn-info'><i class='fa fa-plus'></i> Add</a>&nbsp;";
