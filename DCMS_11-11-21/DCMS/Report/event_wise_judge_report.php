    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
                ...
                <section>
                    <center>
                        ...
                        <form action="" method="POST" style="border: 3px solid white ; box-shadow: 1px 1px 7px 7px;width: 580px; padding: 22px; border-radius: 7px; margin-right: 10px; margin-top: 50px;">
                            ...
                            <br><center><input type="submit" onclick="window.open('view_event_wise_judge_report.php','_blank')" id="btnregister" name="btnregister" value="Submit" class="btn btn-info" style="width: 151px;"></center><br>                                
                        </form>
                    </center>
                </section>
            </div>
            ...
            if (isset($_POST['btnregister'])) {
                ...
                if($eventid != "")
                {
                    $_SESSION['eventnamejudgewise'] = $eventid;
                }else{
